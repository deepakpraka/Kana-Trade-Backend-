...
import {  EconiaMarkets, EconiaTrade, ENVIRONMENT, SELL } from '@kanalabs/trade';
import dotenv from 'dotenv';

dotenv.config();

export default async function placeLimitSellOrder(fastify: FastifyInstance) {
    fastify.get(
        '/',
        async function (
            ...
            try {
                ...
                const buyOrderPayload = await marketData.placeLimitOrder(SELL, 0.5, 3);
